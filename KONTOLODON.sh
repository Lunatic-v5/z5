...
CDNF="https://raw.githubusercontent.com/Lunatic-v5/z5/main"
...
function finish(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/Lunatic-v5/MEGALODON/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/Lunatic-v5/MEGALODON/main/ip | grep $MYIP | awk '{print $3}')
